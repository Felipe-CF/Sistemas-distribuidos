...
def add_UploadServicoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ServicoUploadArquivo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ProtoBUffer__pb2.DadosArquivo.FromString,
                    response_serializer=ProtoBUffer__pb2.UploadResposta.SerializeToString,
            ),
    }
...
class UploadServico(object):
    ...
    @staticmethod
    def ServicoUploadArquivo(request,
            target,
            options=(),
